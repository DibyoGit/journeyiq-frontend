                        ...
                        <Card>
                            ...
                            <div>
                                ...
                                <div style={{ display: "flex", flexDirection: 'row', justifyContent: "space-between", padding: "5px", alignItems: "center", marginBottom: "10px" }}>
                                    ...
                                    {/*  <SelectionFilter option={durationOptions} setSelection={setdateSelection} Placeholder="Date" selected={dateSelection} /> */}
                                        ...
                                        filterData.length > 0 ?
                                            <div style={{ fontSize: "12px", fontWeight: "light", width: "100%" }}>
                                                <div className=" flex flex-col gap-2">
                                                    {
                                                        Object.values(clubbed)?.map(data => {
                                                            ...
                                                            return (
                                                                ...
                                                                <Collapser duration={duration} date={data[0].loadTime}>
